...
impl ExpireSnapshotsAction {
    ...
    /// Preview the snapshot ids and ref names this action would remove.
    pub fn planned_removals(&self, table: &Table) -> Result<(Vec<i64>, Vec<String>)> {
        ...
        Ok((plan.ids_to_remove, plan.refs_to_remove))
    }
